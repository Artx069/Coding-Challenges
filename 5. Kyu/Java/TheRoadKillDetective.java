        ...
        if(photo.trim().matches("[=]+") || photo.trim().contains(" ") || photo.trim().length() < 1){
          return "??";
            ...
            for(String s : ANIMALS){
              ...
              else if(new StringBuilder(s).reverse().toString().matches(regex)){
                return s;
              }
            }
