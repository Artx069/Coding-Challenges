        ...
        if(startPriceOld >= startPriceNew){
           return new int[]{0, startPriceOld-startPriceNew};
            ...
            do {
                ...
                sPN = (sPN * ((100 - percentLossByMonth)/100));
                sPO = (sPO * ((100 - percentLossByMonth)/100));
                savingOverMonths = savingperMonth * months;
                saving = savingOverMonths + sPO - sPN;

            }while(saving < 0);
    
            sol[0] = months;
            sol[1] = (int)Math.round(saving);
        return sol;
      }
}
