...
var fizzBuzzCustom = function (stringOne, stringTwo, numOne, numTwo) {
  ...
  let def1 = stringOne != null ? stringOne : "Fizz";
  let def2 = stringTwo != null ? stringTwo : "Buzz";
  let defN1 = numOne != null ? numOne : 3;
  let defN2 = numTwo != null ? numTwo : 5;

  let sol = [];

  for (let i = 1; i <= 100; i++) {
    if (i % defN1 == 0 && i % defN2 == 0) {
      sol.push(def1 + def2);
    } else if (i % defN1 == 0) {
      sol.push(def1);
    } else if (i % defN2 == 0) {
