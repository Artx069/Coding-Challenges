...
const wikidata_scraper = async (url) => {
  ...
  let id, label, description;

  try {
    id = json["entities"][Object.keys(json["entities"])[0]]["id"];
  } catch {
    id = "No Id";
  }
  ...
  try {
    label =
      json["entities"][Object.keys(json["entities"])[0]]["labels"]["en"][
        "value"
      ];
  } catch {
    label = "No Label";
  ...
  try {
    description =
      json["entities"][Object.keys(json["entities"])[0]]["descriptions"]["en"][
        "value"
      ];
  } catch {
    description = "No Description";
